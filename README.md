...
# 𝓜𝓪𝓲𝓷 𝓢𝓴𝓲𝓵𝓵𝓼 🛠 ~
[![My Skills](https://skillicons.dev/icons?i=js,py,ruby,php,supabase,github,react,git,mongodb,mysql,notion,nodejs,postman,express,docker,java,typescript,arch,jenkins,cpp,cs,dotnet,html,css,bootstrap,androidstudio,linux,)](https://skillicons.dev)
</br>

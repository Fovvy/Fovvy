...
# 𝓜𝓪𝓲𝓷 𝓢𝓴𝓲𝓵𝓵𝓼 🛠 ~
[![My Skills](https://skillicons.dev/icons?i=js,py,rails,php,supabase,github,react,git,mongodb,mysql,notion,nodejs,postman,express,eclipse,java,typescript,jest,jenkins,cpp,cs,dotnet,html,css,bootstrap,androidstudio,linux,)](https://skillicons.dev)
</br>
